...
saf3ai_setup.start("custom")  # the SDK's framework-agnostic integration

from fastapi import FastAPI  # noqa: E402
from fastapi.responses import JSONResponse  # noqa: E402
from pydantic import BaseModel  # noqa: E402

import agent  # noqa: E402  (builds the agent)

app = FastAPI(title="Saf3AI sample agent (OpenAI Agents SDK)")
...
@app.get("/healthz")
def healthz():
    return {"status": "ok", "framework": "openai-agents", "model": agent.MODEL}
